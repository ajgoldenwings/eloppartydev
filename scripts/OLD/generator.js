(function(document) {
	...
	var Generator = class Generator {
		...
		map(object) {
			...
			// +'&amp;markers='+object.pins+'                                                           https://www.google.com/maps/embed/v1/place?key={BROWSER_KEY}&q={YOUR_ADDRESS_ENCODED}
			return '<iframe style="width:'+object.width+';height:'+object.height+'" scrolling="no" src="https://maps.googleapis.com/maps/api/staticmap?center=63.259591,-144.667969&zoom=6&size=400x400\&markers=color:blue%7Clabel:S%7C62.107733,-145.541936&markers=size:tiny%7Ccolor:green%7CDelta+Junction,AK\&markers=size:mid%7Ccolor:0xFFFF00%7Clabel:C%7CTok,AK"&key="></iframe>';
